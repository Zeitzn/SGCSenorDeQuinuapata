...
{
    public class ReportAsistenciaViewModel
    {
        public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }

        public ReportAsistenciaViewModel()
        {
        ...
        public class ReportDataSet
        {
            ...
            public IEnumerable<AsistenciaResponse> DataSetData { get; set; }
        ...
        public string ReporExportExtention
        {
            get
            {
                switch (Format)
                {
                    case ReportAsistenciaViewModel.ReportFormat.Word: return ".doc";
                    case ReportAsistenciaViewModel.ReportFormat.Excel: return ".xls";
                    default:
                        return ".pdf";
                }
            }
