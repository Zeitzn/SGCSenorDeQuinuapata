...
{
    public class ReportConsumoViewModel
    {
        public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }

        public ReportConsumoViewModel()
        {
        ...
        public class ReportDataSet
        {
            ...
            public IEnumerable<CostoUnitarioDepartamentoResponse> DataSetData { get; set; }
        ...
        public string ReporExportExtention
        {
            get
            {
                switch (Format)
                {
                    case ReportConsumoViewModel.ReportFormat.Word: return ".doc";
                    case ReportConsumoViewModel.ReportFormat.Excel: return ".xls";
                    default:
                        return ".pdf";
                }
            }
